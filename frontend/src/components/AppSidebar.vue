...
<template>
  ...
  >
    <div class="app-sidebar-head">
      ...
      <Button class="app-control-button app-sidebar-toggle" type="button" @click="preferences.toggleSidebar">
    ...
    <div class="app-sidebar-footer">
      ...
      <div v-if="!preferences.state.sidebarCollapsed" class="app-sidebar-tools">
        <AppFooterTools />
      </div>
    </div>
  </aside>
