...
/// Offset window with optional search-window signals.
///
...
pub struct HealthResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub library_dependency_gates: Option<Vec<LibraryDependencyGateResponse>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl ApiErrorResponse {
    ...
    pub fn code_enum(&self) -> anyhow::Result<crate::errors::ApiErrorCode> {
        self.code.parse()
    }
