...
pub use facade::{
    ...
    ExtractionTemplateResponse, FileBatchItem, FileBatchRequest, GroupKind, GroupResponse,
    HealthResponse, IngestOptions, LibraryFileDetailResponse, MetadataDataType, MetadataFilter,
