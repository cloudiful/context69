...
use crate::api::{
    ...
    tasks::{
        ...
        __path_submit_vector_index_rebuild,
    },
    translations::{
...
use crate::contracts::{
    ...
    LibraryResourcePageResponse, LibraryResourceSortBy, LibraryTreeResponse, MetadataDataType,
    MetadataFilter, MetadataFilterOperator, MetadataIndexPageQuery, MetadataIndexPageResponse,
    ...
    TaskItemsQuery, TaskItemsResponse, TaskKind, TaskListQuery, TaskPageResponse, TaskProgress,
    TaskRef, TaskResponse, TaskRetryResponse, TaskStatus, TextBatchRequest, TranslationDirective,
